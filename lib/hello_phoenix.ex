defmodule HelloPhoenix do
  ...
  alias HelloPhoenix.Plug.PipelineInstrumenter
  alias HelloPhoenix.Plug.MetricsExporter
  ...
  def start(_type, _args) do
    ...
    Endpoint.Instrumenter.setup()
    HelloPhoenix.Repo.Instrumenter.setup()
    ...
    children = [
      ...
      #   HelloPhoenix.Worker.start_link(arg1, arg2, arg3)
